...
var onCronTrigger = (runtime2, _payload) => {
  ...
  runtime2.log(`[MemoryVault] Hello World — scaffolding verified at ${timestamp}`);
  runtime2.log(`[MemoryVault] CRE SDK loaded successfully`);
  runtime2.log(`[MemoryVault] Config schedule: ${runtime2.config.schedule}`);
